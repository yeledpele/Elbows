...
namespace BinaryEyes.Common.Extensions
{
    ...
    public static class ComponentLoggingExtensions
    {
        ...
        public static T LogMessage<T>(this T component, string format, params object[] args) where T : Component
        {
        ...
        public static T LogError<T>(this T component, string format, params object[] args) where T : Component
        {
#if UNITY_EDITOR || DEBUG || FORCE_LOG
            var message = string.Format(format, args);
        ...
        public static T LogWarning<T>(this T component, string format, params object[] args) where T : Component
        {
#if UNITY_EDITOR || DEBUG || FORCE_LOG
            var message = string.Format(format, args);
